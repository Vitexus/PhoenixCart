...
EOSQL;
    ...
    public function build_info() {
     ...
     if ((array_key_exists('currencies', $GLOBALS) === false) || (array_key_exists('currency', $_SESSION) === false  )){
        $GLOBALS['currencies'] = Guarantor::ensure_global('currencies', DEFAULT_CURRENCY);
