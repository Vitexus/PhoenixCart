...
class hook_shop_siteWide_styleSheets {
  ...
  function listen_injectSiteStart() {
    ...
    $str = file_get_contents('templates/' . TEMPLATE_SELECTION . '/static/queries.css');
    $str = file_get_contents('templates/' . TEMPLATE_SELECTION . '/static/screen.css');
    $str = file_get_contents('templates/' . TEMPLATE_SELECTION . '/static/phoenix.css');
$str = str_replace("\n", "", $str);
$str = str_replace("\t", " ", $str);
$str = str_replace("\t", " ", $str);
$str = str_replace("  ", " ", $str);
